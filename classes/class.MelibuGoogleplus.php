 ...
 */
if (!class_exists('MELIBU_PLUGIN_SSS_GOOGLE')) {

    class MELIBU_PLUGIN_SSS_GOOGLE {
        ...
        public function login() {
            ...
            <div class="mb-sharing-social-safe">
                <div class="mb-plugin-sss-login-button">
                    <a href="#" class="googlepluss">
                        <i class="fa fa-google-plus"></i> <?php _e('Connect with Google', 'sharing-social-safe'); ?>+
                    </a>
                </div>
            </div>
            <?php
...
//                var_dump($accessToken->getValue());
    ...
    global $melibuPluginSSSgoogle;
    $melibuPluginSSSgoogle = new MELIBU_PLUGIN_SSS_GOOGLE();
}
